CalderData <- read.csv("Calder data.csv", header = TRUE)
day <- CalderData$Day
flowrate <- CalderData$Flowrate
height <- CalderData$Riverheight
...
scaledqm <- (197.5 - min(flowrate)) / (max(flowrate) - min(flowrate))
scaledqt <- (142 - min(flowrate)) / (max(flowrate) - min(flowrate))

### Plot graph and straight lines ###
plot(heightandday, flowandday, pch=".", axes=FALSE, xlab=NA, ylab=NA, xaxt='n', yaxt='n', main="Calder graph")
...
polygon(x=scaledday[131:164], y=scaledflow[131:164], col="grey")
...
segments(x0=scaledday[131], y0=scaledqt, x1=scaledday[165], y1=scaledqt)
segments(x0=scaledday[131], y0=scaledqm, x1=scaledday[165], y1=scaledqm)
segments(x0=scaledday[131], y0=scaledqt, x1=scaledday[131], y1=scaledqm)
segments(x0=scaledday[165], y0=scaledqt, x1=scaledday[165], y1=scaledqm)
segments(x0=scaledday[131], y0=-0.35, x1=scaledday[131], y1=scaledqt, lty=3)
segments(x0=scaledday[165], y0=-0.35, x1=scaledday[165], y1=scaledqt, lty=3)
arrows(x0=scaledday[131], y0=-0.35, x1=scaledday[165], y1=-0.35, length = 0.05, code=3)
...
text(x=scaledday[330], y=-0.55, label="FEV ≈ 1.65Mm^3", cex=0.5)
text(x=scaledday[350], y=-0.62, label="Tf = 8.25hrs", cex=0.5)
text(x=scaledday[350], y=-0.69, label="hT = 4.50m", cex=0.5)
text(x=scaledday[350], y=-0.76, label="hM = 5.25m", cex=0.5)
text(x=scaledday[320], y=-0.83, label="Qt = 142.0", cex=0.5)
text(x=scaledday[370], y=-0.82 ,label=expression("m"^3), cex=0.5)
text(x=scaledday[385], y=-0.82 ,label="/s", cex=0.5)
text(x=scaledday[320], y=-0.9, label="Qm = 197.5", cex=0.5)
